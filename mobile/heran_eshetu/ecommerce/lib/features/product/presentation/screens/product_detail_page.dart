...
import '../../../chat/presentation/bloc/bloc/chat_bloc.dart';
...
class ProductDetailPage extends StatelessWidget {
  final User user;
  const ProductDetailPage({super.key, required this.user});
...
class _ProductDetailPageBody extends StatefulWidget {
  ...
  _ProductDetailPageBody({required this.product, required this.user});
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                product.seller.id == widget.user.id
                    ? Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    ...
                    : ElevatedButton(
                        onPressed: () async {
                          BlocProvider.of<ChatBloc>(context)
                              .add(await InitiateChatEvent(product.seller.id));
                        },
                        style: ButtonStyle(
                          padding: const WidgetStatePropertyAll(
                              EdgeInsets.symmetric(
